class SavingDaysModelProductList {
  String? status;
  String? error;
  List<Result>? result;

  SavingDaysModelProductList({this.status, this.error, this.result});

  SavingDaysModelProductList.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    error = json['error'];
    if (json['result'] != null) {
      result = <Result>[];
